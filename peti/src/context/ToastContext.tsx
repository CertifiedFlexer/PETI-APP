...
export const ToastProvider: React.FC<ToastProviderProps> = ({ children }) => {
    ...
    const showToast = (msg: string, toastType: ToastType, toastDuration: number = 4000) => {
    ...
    const showError = (msg: string, toastDuration: number = 5000) => {
        showToast(msg, 'error', toastDuration);
    };

    const showWarning = (msg: string, toastDuration: number = 4000) => {
        showToast(msg, 'warning', toastDuration);
    };

    const showInfo = (msg: string, toastDuration: number = 4000) => {
