        ...
        try {
            ...
            if (!response.ok) {
                if (response.status === 404) {
                    showInfo("No hay paseadores disponibles");
                } else if (response.status === 500) {
                    showError("Error en el servidor. Intenta más tarde");
                } else {
                    showError("Error al cargar paseadores");
                }
                setData([]);
                return;
            }
            ...
            if (error.message === 'Network request failed' || error.message.includes('fetch')) {
                ...
                showError("Error inesperado al cargar paseadores");
            }
            setData([]);
        } finally {
            setLoading(false);
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.emptyStateContainer}>
                    <Ionicons name="walk-outline" size={80} color="#ccc" />
                    <Text style={styles.emptyStateTitle}>No hay paseadores disponibles</Text>
                    ...
                    >
                        ...
                        <View style={styles.cardContent}>
                            ...
                            <Text style={styles.cardCategory}>
                                {provider.tipo_servicio || 'Paseador'}
                            </Text>
