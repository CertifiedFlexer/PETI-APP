        ...
        try {
            ...
            if (!response.ok) {
                if (response.status === 404) {
                    showInfo("No hay veterinarias disponibles");
                } else if (response.status === 500) {
                    showError("Error en el servidor. Intenta más tarde");
                } else {
                    showError("Error al cargar veterinarias");
                }
                setData([]);
                return;
            }
            ...
            if (error.message === 'Network request failed' || error.message.includes('fetch')) {
                ...
                showError("Error inesperado al cargar veterinarias");
            }
            setData([]);
        } finally {
            setLoading(false);
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.emptyStateContainer}>
                    ...
                    <Text style={styles.emptyStateTitle}>No hay veterinarias disponibles</Text>
                    ...
                    >
                        ...
                        <View style={styles.cardContent}>
                            ...
                            <Text style={styles.cardCategory}>
                                {provider.tipo_servicio || 'Veterinaria'}
                            </Text>
