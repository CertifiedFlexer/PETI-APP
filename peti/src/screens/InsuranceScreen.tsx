...
const PROVIDERS: Provider[] = [
    {
        ...
        name: "Seguro Pet Protección Total",
        category: "Seguro",
        description: "Cobertura completa para tu mascota. Incluye emergencias médicas, cirugías, hospitalización y medicamentos.",
        rating: 4.7,
        phone: "+57 313 100 1111",
        address: "Calle 7 Sur #42-70, Medellín",
    },
    {
        id: "2",
        image: "https://picsum.photos/400/250?random=502",
        name: "Vida Pet Seguros",
        category: "Seguro",
        description: "Planes flexibles con cobertura nacional. Asistencia veterinaria 24/7 y red de clínicas afiliadas.",
        rating: 4.6,
        phone: "+57 314 200 2222",
        address: "Carrera 43A #1-50, Medellín",
    },
    {
        id: "3",
        image: "https://picsum.photos/400/250?random=503",
        name: "MascotaSeguros Plus",
        category: "Seguro",
        description: "Protección integral para perros y gatos. Cobertura de accidentes, enfermedades y responsabilidad civil.",
        rating: 4.8,
        phone: "+57 315 300 3333",
        address: "Avenida El Poblado #5A-23, Medellín",
    },
];
                            ...
                            <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                <View style={styles.modalBody}>
                                    ...
                                    <View style={styles.modalRating}>
                                        ...
                                        <Text style={styles.modalRatingSubtext}>(95+ reseñas)</Text>
                                    </View>
